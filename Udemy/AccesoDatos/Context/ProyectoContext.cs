...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-TKSMKV1\\SQLEXPRESS;Database=proyecto;Trust Server Certificate=true;User Id=Udemy;Password=Julieta01!;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F3C48A6AB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FCA0F8853");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FE266188E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F9FB383F1");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC75B665548");
